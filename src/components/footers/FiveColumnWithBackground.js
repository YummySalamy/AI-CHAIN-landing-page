...
import LogoImage from "images/chatboticon.png";
    ...
    <Container>
      <Content>
        <FiveColumns>
          ...
          <Column>
            <ColumnHeading>Software</ColumnHeading>
            <LinkList>
              <LinkListItem>
              ...
              <LinkListItem>
                <Link href="#">Equipo de trabajo</Link>
              </LinkListItem>
            </LinkList>
          </Column>
          <Column>
        ...
        <ThreeColRow>
          <LogoContainer>
            ...
            <LogoText>AI-CHAIN.</LogoText>
          </LogoContainer>
          <CopywrightNotice>&copy; 2023. AI-CHAIN, todos los derechos reservados.</CopywrightNotice>
