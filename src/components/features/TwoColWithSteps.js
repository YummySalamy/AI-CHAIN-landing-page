...
export default ({
  ...
  const defaultSteps = [
    {
      heading: "Registrate",
      description: "Crea una cuenta usando tu correo electronico o tu cuenta de Google."
    },
    {
      heading: "Ingresa",
      description: "Ingresa a la aplicación..."
    },
    {
      heading: "¡Listo!",
      description: "Ya estás preparado para utilizar tu chatbot de preferencia."
    }
  ];
