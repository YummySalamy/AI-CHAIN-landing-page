...
export default ({
  ...
  description = "Breve introducción... lorem ipsum dolor siamet, consectetur adipiscing elit.",
  primaryButtonText = "Aprende más",
  ...
  const defaultFeatures = [
    {
      ...
      description: "La arquitectura de nuestro chatbot permite agilizar en gran medida tus tiempos de trabajo.",
